...
const projects = [
  {
    id: 1,
    title: "Saas Landing Page2",
    description: "Hello this is a landing page",
    ...
    <section id="projects" className="py-24 px-24 relative">
      <div className="contaier mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          Here are some of feature Projects
        </p>
        ...
        <div className="text-center mt-12">
          <a
            ...
            href="https://github.com/Nagarjuna4085"
            target="_blank"
          >
            Check My Github <ArrowRight size={10} />
          </a>
        </div>
      </div>
    </section>
