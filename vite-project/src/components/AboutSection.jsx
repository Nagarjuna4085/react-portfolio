      ...
      <div className="container mx-auto mac-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h1 className="text-2xl font-semibold">Passionate Web Developer</h1>
            ...
            <p className="text-muted-foreground">
              ...
              problems, and I'm consistantly learning new technologies and
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
              <a
                href="#contact"
                className="cosmic-button rounded-full border border-primary text-primary-foreground hover:bg-primary/10 transition-colors duration-300"
              >
                Get in touch
              </a>
